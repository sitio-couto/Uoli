...
reading_sonars:
		...
		bne reading_sonars		@ Caso nao eh o ultimo sonar, repete
...
@ R0: Endereco fornecido para devolver o retorno ao usuario.
		push {r4-r12, lr}
		mov r10, r0			@ Guarda a posicao onde deve ser retornado o valor

		mov r7, #20			@ Carrega o valor da syscall get_time
		svc 0x0					@ Realiza a syscall
		str r0, [r10]		@ Armazena o retorno no endereco forncido pelo usuario
